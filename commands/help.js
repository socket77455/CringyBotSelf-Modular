...
**${config.prefix}ascii** <text> - turns test to ascii.
...
**${config.prefix}quote** <message-id> - quotes a message in an embed.
**${config.prefix}terminal** <command> - runs a terminal command.
